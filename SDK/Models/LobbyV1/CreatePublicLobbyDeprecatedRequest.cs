...
using SDK.Utils;
    ...
    /// </summary>
        ...
        internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, CreatePublicLobbyDeprecatedRequest value, string baseUrl)
        {
            if("CreatePublicLobbyDeprecated" == operationId)
            {
                ...
                var message = new HttpRequestMessage(HttpMethod.Post, baseUrl + $"/lobby/v1/{appId}/create/public" + queryParamString);
                
                
                
                return message;
            }
            throw new ArgumentException($"Attempt to build HttpRequestMessage for invalid operationId [{operationId}] for request type [CreatePublicLobbyDeprecatedRequest]");
        }
    }
}