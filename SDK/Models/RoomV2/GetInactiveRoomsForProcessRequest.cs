...
using SDK.Utils;
    ...
    public class GetInactiveRoomsForProcessRequest
    {
        ...
        internal static HttpRequestMessage BuildHttpRequestMessage(string operationId, GetInactiveRoomsForProcessRequest value, string baseUrl)
        {
            if("GetInactiveRoomsForProcess" == operationId)
            {
                ...
                var message = new HttpRequestMessage(HttpMethod.Get, baseUrl + $"/rooms/v2/{appId}/list/{processId}/inactive");
                return message;
            }
