...
//------------------------------------------------------------------------------
#nullable enable
namespace SDK.RoomV2
{
    using System;
using System.Collections.Generic;
using System.Threading.Tasks;
using Newtonsoft.Json;
using SDK.Models.RoomV2;
...
using SDK.Utils;
    ...
    public async Task<CreateRoomResponse> CreateRoomAsync(CreateRoomSecurity security, CreateRoomRequest request)
    {
        ...
        if((response.StatusCode == 201))
        {
            ...
            {
                response.ConnectionInfoV2 = JsonConvert.DeserializeObject<ConnectionInfoV2>(await httpResponseMessage.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer() }});
            }
            return response;
        }
        ...
        if((response.StatusCode == 403))
        {
            if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
            {
                response.CreateRoom403ApplicationJSONString = await response.RawResponse.Content.ReadAsStringAsync();
            }
            return response;
        }
