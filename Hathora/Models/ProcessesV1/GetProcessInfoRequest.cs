    ...
    public class GetProcessInfoRequest
    {
        ...
        internal static UnityWebRequest BuildHttpRequestMessage(string operationId, GetProcessInfoRequest value, string baseUrl)
        {
            if("GetProcessInfo" == operationId)
            {
                ...
                var processId = PathParamSerializer.Serialize("simple", false, value.ProcessId);var urlString = baseUrl + $"/processes/v1/{appId}/info/{processId}";var message = UnityWebRequest.Get(urlString);
                return message;
            }
